...
import { ChevronRight, ShoppingBag, Heart, Zap, Star, TrendingUp } from "lucide-react"
        ...
        <section className="bg-gradient-to-br from-teal-50 via-white to-blue-50 pt-6 pb-12">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-600">Trendy & Elegant Fashion</p>
            </div>

            {/* Quick Action Buttons */}
            <div className="grid grid-cols-3 gap-3 mb-8">
              <Link href="/shop">
                <div className="bg-white border border-gray-200 rounded-xl p-4 text-center hover:border-teal-300 transition-colors cursor-pointer">
                  <ShoppingBag size={24} className="text-teal-600 mx-auto mb-2" />
                  <p className="text-xs font-semibold text-gray-900">Shop</p>
                </div>
              </Link>
              <div className="bg-white border border-gray-200 rounded-xl p-4 text-center hover:border-red-300 transition-colors cursor-pointer">
                <Heart size={24} className="text-red-500 mx-auto mb-2" />
                <p className="text-xs font-semibold text-gray-900">Wishlist</p>
              </div>
              <div className="bg-white border border-gray-200 rounded-xl p-4 text-center hover:border-yellow-300 transition-colors cursor-pointer">
